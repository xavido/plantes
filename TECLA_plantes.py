...
def main():
    ...
    '''
    history_chat = 'Fem un joc i imaginem que et dius Maria i ets la millor experta en plantes (Plantae). Només contesta preguntes sobre plantes (Plantae).' \
                   'Necessito que em parlis com si tingues 8 anys i la resposta ha de ser 4 frases. Aquesta és la pregunta...'
    back_chat = 'Contesta si la pregunta està relacionada amb plantes (Plantae). Contesta en català.'
    # Get user input
    user_query = st.text_input("Escriu la teva pregunta aquí :q", "Què son les plantes?")
    ...
    if user_query != ":q" or user_query != "":
       ...
       # '''
        ...
        sql = "INSERT INTO iespuigigairalt_plantes (pregunta, respuesta) VALUES (%s,%s)"
        ...
        image_url = "https://www.jardineriaon.com/wp-content/uploads/2021/10/plantas-del-bosque-mediterraneo.jpeg"
        # Realiza la búsqueda
